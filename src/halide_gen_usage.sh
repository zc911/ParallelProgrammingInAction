...
# ./blur_generator -o . -g auto_blur_mat -f auto_blur_mat -e static_library,h,schedule -p /home/chenzhen/Workspace/hpc/halide_build/distrib/lib/libautoschedule_mullapudi2016.so  target=host auto_schedule=true
./blur_generator -o . -g auto_blur_mat -f auto_blur_mat -e static_library,h,schedule -p /home/chenzhen/Workspace/hpc/halide_build/distrib/lib/libautoschedule_adams2019.so  target=host auto_schedule=true
# ./blur_generator -o . -g auto_blur_mat -f auto_blur_mat -e static_library,h,schedule -p /home/chenzhen/Workspace/hpc/halide_build/distrib/lib/libautoschedule_li2018.so  target=host auto_schedule=true


# That should create a pair of files in the current directory:
# "blur_generator.a", and "blur_generator.h", which define a
# function "blur_generator" representing the compiled pipeline.

check_file_exists blur_mat.a
check_file_exists blur_mat.h
check_symbol blur_mat.a blur_mat
...
./blur_generator \
    -g blur_generator \
    -f blur_generator_win32 \
    -o . \
    target=x86-32-windows

# This generates a file called "blur_generator_win32.lib" in the
# current directory, along with a matching header. The function
# defined is called "blur_generator_win32".

check_file_exists blur_generator_win32.lib
check_file_exists blur_generator_win32.h
...
./blur_generator -g blur_generator -e stmt -o . target=host

check_file_exists blur_generator.stmt
...
# ./blur_generator -g my_second_generator -f my_second_generator_1 -o . \
# target=host parallel=false scale=3.0 rotation=ccw output.type=uint16

# ./blur_generator -g my_second_generator -f my_second_generator_2 -o . \
# target=host scale=9.0 rotation=ccw output.type=float32

# ./blur_generator -g my_second_generator -f my_second_generator_3 -o . \
...
./blur_generator \
    -g blur_generator \
    -f blur_generator_avx \
    -e object,c_header\
    -o . \
    target=host-x86-64-avx-no_runtime

# These files don't contain the runtime
check_no_runtime blur_generator_basic.o
check_symbol     blur_generator_basic.o blur_generator_basic
check_no_runtime blur_generator_sse41.o
check_symbol     blur_generator_sse41.o blur_generator_sse41
check_no_runtime blur_generator_avx.o
check_symbol     blur_generator_avx.o blur_generator_avx
...
# processors.
ar q blur_generator_multi.a \
    blur_generator_basic.o \
    blur_generator_sse41.o \
    blur_generator_avx.o \
    halide_runtime_x86.o

check_runtime blur_generator_multi.a
check_symbol  blur_generator_multi.a blur_generator_basic
check_symbol  blur_generator_multi.a blur_generator_sse41
check_symbol  blur_generator_multi.a blur_generator_avx
